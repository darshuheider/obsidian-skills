...
| [obsidian-rest-api](skills/obsidian-rest-api) | Interact with an Obsidian vault via the [Local REST API plugin](https://github.com/coddingtonbear/obsidian-local-rest-api)|
